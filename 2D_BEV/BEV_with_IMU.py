    ...
    while True:
        ...
        if imuQueue.has():
            ...
            for packet in imuData.packets:
                ...
                qw, qx, qy, qz = rv.w, rv.x, rv.y, rv.z
        ...
        # Overlay IMU text on RGB frame
        imu_text = f"Roll: {math.degrees(roll):.1f}°  Pitch: {math.degrees(pitch):.1f}°  Yaw: {math.degrees(yaw):.1f}°"
        cv2.putText(rgbFrame, imu_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
