...
#nn.setBlobPath(blobconverter.from_zoo("YOLOv8n_coco_640x352", shaves=6))
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        stacked = np.vstack((cv2.resize(frame, (GRID_WIDTH * CELL_SIZE, GRID_HEIGHT * CELL_SIZE)), grid_img))
        cv2.imshow("VisionCap: YOLOv8 Navigation", stacked)
