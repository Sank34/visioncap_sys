...
# Global goal cell (updated via mouse)
goal_cell = [0, grid_cols // 2]
def on_mouse_Test(event, x, y, flags, param):
    if event == cv2.EVENT_LBUTTONDOWN:
        print(f"[DEBUG] Mouse event: {event}, x={x}, y={y}")
...
cv2.setMouseCallback("Occupancy Grid", on_mouse_Test)
